...
import com.p3lj2.koveepetshop.adapter.LogSupplierAdapter;
...
public class SupplierLogFragment extends Fragment {
    ...
    private LogSupplierAdapter logAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_supplier_log, container, false);
    }
    ...
    private void initRecyclerView() {
        logAdapter = new LogSupplierAdapter();
    ...
    private void getData() {
        logViewModel.getSupplier(employee.getToken()).observe(getViewLifecycleOwner(), new Observer<List<SupplierModel>>() {
            @Override
            public void onChanged(List<SupplierModel> supplierModels) {
                if (supplierModels != null) {
                    logAdapter.setItems(supplierModels);
                }
            }
        });
    }
